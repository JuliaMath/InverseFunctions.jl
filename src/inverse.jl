...
inverse(f::Base.Fix1{typeof(*)}) = iszero(f.x) ? NoInverse(f) : Base.Fix1(\, f.x)
inverse(f::Base.Fix2{typeof(*)}) = iszero(f.x) ? NoInverse(f) : Base.Fix2(/, f.x)
inverse(f::Base.Fix1{typeof(/)}) = Base.Fix2(\, f.x)
inverse(f::Base.Fix2{typeof(/)}) = Base.Fix2(*, f.x)
inverse(f::Base.Fix1{typeof(\)}) = Base.Fix1(*, f.x)
inverse(f::Base.Fix2{typeof(\)}) = Base.Fix1(/, f.x)
...
inverse(f::Base.Fix2{typeof(^)}) = iszero(f.x) ? NoInverse(f) : Base.Fix2(invpow2, f.x)
